...
<html lang="en">
  ...
  <body>
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Cari Mixue</a>
        </div>
        <div class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav">
            {{-- <a href="#" data-toggle="collapse" data-target=".navbar-collapse.in" id="about-btn" class="" aria-expanded="true"><i class="fa fa-question-circle white"></i>&nbsp;&nbsp;About</a> --}}
            <li><a href="/" style="color: white" onmouseover="this.style.color='#C0C0C0'" onmouseout="this.style.color='#ffffff'"><i class="fa fa-home white"></i>&nbsp;&nbsp;Home</a></li>
            <li><a href="#" class="mixue-terdekat" style="color: white" onmouseover="this.style.color='#C0C0C0'" onmouseout="this.style.color='#ffffff'"><i class="fa fa-search white"></i>&nbsp;&nbsp;Mixue Terdekat</a></li>
            ...
            <li class="hidden-xs"><a href="#" style="color: white" onmouseover="this.style.color='#C0C0C0'" onmouseout="this.style.color='#ffffff'" data-toggle="collapse" data-target=".navbar-collapse.in" id="list-btn"><i class="fa fa-list white"></i>&nbsp;&nbsp;POI List</a></li>
          </ul>
        </div><!--/.navbar-collapse -->
      </div>
    </div>
    ...
    <div class="modal fade" id="featureModal" tabindex="-1" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <select class="custom-select" id="pilihInfo">
    ...
    <div class="modal fade" id="mixueterdekatModal" tabindex="-1" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button class="close" type="button" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title text-primary" id="mixue-terdekat-title">5 Mixue Terdekat</h4>
          </div>
          <div class="modal-body" id="mixue-terdekat-info">
            <table class="table table-bordered">
              <thead>
                  <tr>
                      ...
                      <th scope="col">Meluncurr</th>
                  </tr>
              </thead>
              <tbody id="isiMixueTerdekat">
